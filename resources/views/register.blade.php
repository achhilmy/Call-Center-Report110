...
<style>
	body { background-image: url("assets/dist/img/polisi3.jpg")}
</style>
<!------ Include the above in your HEAD tag ---------->


    <div class="container" style="margin-top:40px; background-image: {{url('/assets/dist/img/polisi.jpg')}};">
		<div class="row">
			<div class="col-sm-6 col-md-4 col-md-offset-4">
                ...
                {{csrf_field()}}
								...
								<div class="row">
									<div class="center-block">
										<img class="profile-img"
											src="{{url('/assets/dist/img/110.png')}}" alt="">
									</div>
								</div>
								<div class="row">
					...
					<div class="panel-footer ">
						Do you have an account! <a href="{{url('login')}}"> Login </a>
					</div>
                </div>
			</div>
		</div>
